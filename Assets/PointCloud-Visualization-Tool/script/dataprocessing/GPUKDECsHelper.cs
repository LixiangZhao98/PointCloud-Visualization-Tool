...
//         nodeDen = new ComputeBuffer(dF.GetNodeNum(), sizeof(float));
//         parDen = new ComputeBuffer(pG.GetParticlenum(), sizeof(float));
//         SL_modified = new ComputeBuffer(dF.GetNodeNum(), 3 * sizeof(float));
//         
//         
//         int kde = KDE_Cs.FindKernel("Pilot");
//         // int kernel_SL_Modified = KDE_Cs.FindKernel("SL_Modified");
//         // int kernel_FinalDensity = KDE_Cs.FindKernel("FinalDensity");
//
...
//         
//         KDE_Cs.SetBuffer(kde, "partiPos_", parPos);
//         KDE_Cs.SetBuffer(kde, "nodePos_", nodePos);
//         KDE_Cs.SetBuffer(kde, "nodeDen_", nodeDen);
//         KDE_Cs.SetBuffer(kde, "parDen_", parDen);
//         KDE_Cs.SetBuffer(kde, "SL_ModifiedRW_", SL_modified);
//         
//         
//
//         
...
//         sw.Start();
//         //-------------------------------------------------------------------------------------------------kernel 0
//         KDE_Cs.Dispatch(kde, dF.XNUM / GROUPSIZE, dF.YNUM / GROUPSIZE, dF.ZNUM / GROUPSIZE);  //KDE density
//         
//         nodeDen.GetData(dens);
//         sw.Stop();
//         
